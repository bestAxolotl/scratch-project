...
eventController.activitySearch = (req, res) => { 
  //TABLES: activities
  console.log("greetings from inside of the activity search controller");
...
eventController.activityDetailPageDisplay = (req, res) => {
  console.log("greetings from inside of the activityDetailPageDisplay controller");
...
eventController.confirmParticipation = (req, res) => {
  console.log("greetings from inside of the confirmParticipation controller");
...
eventController.saveAsMaybe = (req, res) => {
  console.log("greetings from inside of the saveAsMaybe controller");
...
eventController.submitChatText = (req, res) => {
  console.log("greetings from inside of the submitChatText controller");
...
eventController.viewProfile = (req, res) => {
  console.log("greetings from inside of the viewProfile controller");
...
eventController.createActivity = (req, res) => {
  console.log("greetings from inside of the createActivity controller");
...
eventController.generateLatAndLong = (req, res) => {
  console.log("greetings from inside of the generateLatAndLong controller");
...
eventController.createAccount = (req, res) => {
  console.log("greetings from inside of the createAccount controller");
